...
http_archive(
    ...
    # Replace the commit hash (a14ad3a64e7bf398ab48105aaa0348e032ac87f8) in both places (below) with the latest (https://github.com/hedronvision/bazel-compile-commands-extractor/commits/main), rather than using the stale one here.
...
# Needed to add this to make absl work
http_archive(
    name = "bazel_skylib",
